...
- [BI (дашборд): Yandex DataLens](https://datalens.yandex/t0aal77eif0ge).
...
[➡️**Нажмите, чтобы перейти к дашборду**](https://datalens.yandex/t0aal77eif0ge)
...
* **Когортный анализ:** витрина для измерения удержания клиентов поквартально (Quarterly Retention Rate).
